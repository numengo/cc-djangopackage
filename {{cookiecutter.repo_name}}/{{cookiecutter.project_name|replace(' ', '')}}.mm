...
<node FOLDED="false" ID="ID_822712631" CREATED="1564511595253" MODIFIED="1577179731947"><richcontent TYPE="NODE">
...
<attribute NAME="cc_template" VALUE="cc-djangopackage"/>
...
<attribute NAME="app_config_name" VALUE="{{cookiecutter.app_config_name}}"/>
<attribute NAME="django_versions" VALUE="{{cookiecutter.django_versions}}"/>
...
<node TEXT="{{ cookiecutter.models }}" ID="ID_429317044" CREATED="1574097378000" MODIFIED="1574097391160"/>
</node>
